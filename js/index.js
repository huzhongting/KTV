                    ...
                    controller:["$scope","$ionicHistory","$ionicActionSheet",
                        function ($scope,$ionicHistory,$ionicActionSheet) {
                            $ionicActionSheet.show({
                                buttons:[
                                    {text:"<img src='img/qiantai/pic19.png' width='60px'/>"},
                                    {text:"<img src='img/qiantai/pic20.png' width='60px'/>"},
                                    {text:"<img src='img/qiantai/pic22.png' width='60px'/>"},
                                    {text:"<img src='img/qiantai/pic23.png' width='60px'/>"}
                                ],
                                cancelText:"取消",
